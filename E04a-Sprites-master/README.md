...
main1 - copied code for panda then altered to repeat 20 times while retaining panda 

main2 - copied code for alligator and emote, changed image asset to new animal

main3 - used code similar to that shown in previous smile project in order to establish tracking mouse. with alterations to follow animal assets.
